...
rl.question('Please enter the directory models path: ', (parenFolderPath) =>{
...
`;
        ...
        const controllerPath = path.join(currentDir, 'controllers2', `${modelName.toLowerCase()}Controller.js`);
...
//console.log(routerContent);
        ...
        const routerPath = path.join(currentDir, 'routes2', `${modelName.toLowerCase()}_Routes.js`);
